 ...
 * @author tomatenjoe
 */
public class DruckerKopf {
    Integer serverPort = 9871;
    public static boolean isTCPConnection = true;
    Integer timeMultiplikator = 0;
    
    HashMap <String,TonerHelper> toners = new HashMap<String,TonerHelper>();
    ...
    private void printData(File data) throws IOException{
        ...
        //    sendStatus.sendString("Toner "+toner.getKey()+" Füllstand: "+toner.getValue().getFullstand()+" Gram");
        }
